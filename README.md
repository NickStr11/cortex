...
- **[`CLAUDE.md`](CLAUDE.md)** — правила проекта, 126 строк
- **[`docs/learned-the-hard-way.md`](docs/learned-the-hard-way.md)** — concentrated lookup ~50 production recipes (симптом → причина → фикс с командой)
- **[`memory/subagents-playbook.md`](memory/subagents-playbook.md)** — hub-and-spoke + per-agent model routing с обоснованием
...
- **[`tools/steam-sniper/verify.sh`](tools/steam-sniper/verify.sh)** — пример domain-specific verification (HTTP/SSH/cron checks)
